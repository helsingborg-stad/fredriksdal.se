...
class acf_field_wysiwyg extends acf_field
{
	...
	*/
	...
	function mce_external_plugins( $plugins ){
		...
		// add table plugin
		$plugins['table'] = apply_filters('acf/get_info', 'dir') . 'js/tinymce.table.min.js';
   	...
   	function toolbars( $toolbars ) {
   		...
   		if( version_compare($wp_version, '3.9', '>=' ) ) {
	   		...
	   		$toolbars['Full'] = array(
	   			...
	   			2 => apply_filters( 'mce_buttons_2', array( 'formatselect', 'underline', 'alignjustify', 'forecolor', 'pastetext', 'removeformat', 'charmap', 'outdent', 'indent', 'table', 'undo', 'redo', 'wp_help', 'inserttable', 'code' ), $editor_id ),
	   		...
	   		$toolbars['Full'] = array(
	   			...
	   			2 => apply_filters( 'mce_buttons_2', array( 'formatselect', 'underline', 'justifyfull', 'forecolor', 'pastetext', 'pasteword', 'removeformat', 'charmap', 'outdent', 'indent', 'table', 'undo', 'redo', 'wp_help', 'inserttable', 'code' ), $editor_id ),
